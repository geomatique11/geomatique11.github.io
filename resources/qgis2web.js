...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32632',
            extent: [656090.950000, 600899.000000, 684669.110000, 629049.010000],
            units: 'm'})
    })
});
...
map.getView().fit([644190.896765, 600195.249750, 696569.163235, 629752.760250], map.getSize());
